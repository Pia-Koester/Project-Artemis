      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 w-3/5 mx-auto">
        <div class="bg-white rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105">
          ...
          <div class="p-8">
            ...
            <p class="text-4xl font-bold text-gray-800 mb-6">€{plan.price}.00</p>
          ...
          <div class="p-4">
            <button
              ...
              class={clsx("w-full text-white rounded-full px-4 py-2 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue active:bg-blue-800",
